...
GOOGLE_TRANSLATE_API_KEY = os.environ.get('GOOGLE_TRANSLATE_API_KEY') or 'AIzaSyBOdwh_ADKyGBXMNxWeNaxWwlUCSDHl0K0'
GOOGLE_TRANSLATE_PROJECT_ID = os.environ.get('GOOGLE_TRANSLATE_PROJECT_ID') or 'optimal-tea-476510-e1'
