            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
                ...
                <button 
                  ...
                  className="bg-white/20 border-2 border-white text-white hover:bg-white hover:text-gray-900 hover:border-white font-semibold text-lg px-8 py-4 backdrop-blur-md transform hover:scale-105 transition-all duration-300 rounded-lg"
                >
                  Create Free Account
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
                <button 
                  onClick={() => openAuthModal('register')}
                  className="bg-white text-black hover:bg-gray-100 hover:text-black border-white hover:border-gray-100 shadow-2xl hover:shadow-3xl font-semibold text-lg px-8 py-4 transform hover:scale-105 transition-all duration-300 rounded-lg border-2"
                >
                  Sign Up Free
                </button>
                <Button 
