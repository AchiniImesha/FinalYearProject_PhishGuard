...
const apiService = {
   ...
   * @returns {Promise} Google OAuth URL
   */
  ...
  handleGoogleCallback: async (code) => {
    try {
      console.log('API Service: Handling Google OAuth callback');
      ...
      console.log('API Service: Google OAuth successful for', user.username);
      return response.data;
    } catch (error) {
